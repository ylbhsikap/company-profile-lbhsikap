...
export interface LowonganKarir {
  ...
  deskripsi: string;
  kualifikasi: string[];
  isProgramMitra: boolean; // Menandakan apakah ini program khusus mitra
  mitraTarget?: string;   // Nama mitra (misal: OPLAY.ID)
  backgroundKeahlian?: string[]; // Untuk kriteria IT / Bisnis
  deadline: string;
}
...
// =========================================================================
// 💼 DATA KARIR & MAGANG (Untuk src/app/karir/page.tsx)
// =========================================================================
export const dataKarir: LowonganKarir[] = [
  {
    ...
    backgroundKeahlian: ["Teknologi Informasi (IT)", "Bisnis Ekonomi"],
    deadline: "2026-12-31"
  },
  {
    id: "karir-002",
    ...
    kualifikasi: ["Lulusan S1 Hukum", "Memiliki sertifikat PKPA (disukai)"],
